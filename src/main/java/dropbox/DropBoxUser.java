...
public class DropBoxUser implements User_Interface {
    ...
    private void rewrite_users() {
        try {
            ...
            db_file.delete_file(CloudStroage.getStorageRootPath() + "/users.meta");
            db_file.upload_file("scramble" + File.separator + "users.meta", CloudStroage.getStorageRootPath());
